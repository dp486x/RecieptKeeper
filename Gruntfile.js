...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        jsbeautifier: {
            files: ["public/src/js/*.js", "public/src/js/controllers/*.js", "public/src/js/services/*.js", /*"public/src/!**!/!**!/!*.js",*/ "public/src/css/*.css", /*"public/src/!**!/!**!/!*.css",*/ "server.js", "*.html", "public/src/templates/*.html"],
            options: {
        ...
        uglify: {
            ...
            build: {
                files: {
                    'server.min.js': [ 'server.js'/*'public/src/js/!**!/!*.js', 'public/src/js/main.js', 'public/src/js/services/botFactory.js'*/]
                }
            }
        },
